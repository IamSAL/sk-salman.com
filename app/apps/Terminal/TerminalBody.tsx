...
import terminal from "app/misc/placeholder-data/terminal";
    ...
    render() {
        return (
            ...
            >
                ...
                <div className="font-avenir absolute text-center h-28 mx-auto -mt-20 bottom-0 inset-x-0 top-1/2">
...
export default class TerminalBody extends Component<{}, TerminalState> {
            ...
            <div key={`terminal-input-row-${id}`} className="w-full h-6 flex">
                <div className="w-max hstack">
                    <span className="text-yellow-200">
                        salman@mac <span className="text-green-300">{this.getCurDirName()}</span>
                    </span>
    ...
    render() {
        return (
            <div
                className="terminal font-terminal font-normal relative w-full h-full backdrop-blur-sm  overflow-y-scroll pt-12"
                text="white sm"
